...
print('\nAccuracy comparison using train test split : ')
print("Accuracy score of decission tree:", score_dt)
print("Accuracy score of decission tree after balancing(adasyn) : ", score_dt_ros)


print("Accuracy score of logistic regresion :", score_lr)
print("Accuracy score of logistic regresion after balancing(adasyn):", score_lr_ros)


print("Accuracy score of SVM:", score_svm)
print("Accuracy score of SVM after balancing(adasyn):", score_svm_ros)



plt.figure(figsize=(10,8))
plt.bar(1,score_dt,label ='Decision Tree before balancing', width = 0.1)
plt.bar(1.1,score_dt_ros,label ='Decision Tree after balancing(adasyn)', width = 0.1)

plt.bar(1.4,score_lr,label ='logistic regresion before balancing', width = 0.1)
plt.bar(1.5,score_lr_ros,label ='logistic regresion before balancing(adasyn)', width = 0.1)

plt.bar(1.8,score_svm,label ='SVM before balancing', width = 0.1)
plt.bar(1.9,score_svm_ros,label ='SVM after balancing(adasyn)', width = 0.1)
