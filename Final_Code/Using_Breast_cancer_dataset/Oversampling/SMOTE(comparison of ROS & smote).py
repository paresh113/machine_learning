...
######################  applying  proposed method (visualising the training set result) ######################### 
...
print('\nAccuracy comparison using train test split : ')
print("Accuracy score of decission tree:", score_dt)
print("Accuracy score of decission tree after balancing(ros) : ", score_dt_ros)
print("Accuracy score of decission tree after balancing(our) : ", score_dt_)


print("Accuracy score of logistic regresion :", score_lr)
print("Accuracy score of logistic regresion after balancing(ros):", score_lr_ros)
print("Accuracy score of logistic regresion after balancing(our):", score_lr_)


print("Accuracy score of SVM:", score_svm)
print("Accuracy score of SVM after balancing(ros):", score_svm_ros)
print("Accuracy score of SVM after balancing(our):", score_svm_)



plt.figure(figsize=(10,8))
plt.bar(1,score_dt,label ='Decision Tree before balancing', width = 0.1)
plt.bar(1.1,score_dt_ros,label ='Decision Tree after balancing(ros)', width = 0.1)
plt.bar(1.2,score_dt_,label ='Decision Tree after balancing(our)', width = 0.1)

plt.bar(1.4,score_lr,label ='logistic regresion before balancing', width = 0.1)
plt.bar(1.5,score_lr_ros,label ='logistic regresion before balancing(ros)', width = 0.1)
plt.bar(1.6,score_lr_,label ='logistic regresion after balancing(our)', width = 0.1)

plt.bar(1.8,score_svm,label ='SVM before balancing', width = 0.1)
plt.bar(1.9,score_svm_ros,label ='SVM after balancing(ros)', width = 0.1)
plt.bar(2.0,score_svm_,label ='SVM after balancing(our)', width = 0.1)
